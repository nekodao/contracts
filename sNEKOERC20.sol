...
contract sNEKO is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Neko", "sNEKO", 9) ERC20Permit() {
    ...
    /**
        @notice increases sNEKO supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sNEKO
